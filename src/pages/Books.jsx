        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-ink-400 text-sm">
              {books.length} titles in catalogue
            </p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="card flex flex-col items-center justify-center py-20 text-ink-300">
          ...
          <p className="text-sm mt-1">
            {search ? "Try different keywords" : "Add your first book above"}
          </p>
        </div>
      ) : view === "grid" ? (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 animate-slide-up">
          {filtered.map((book, i) => (
            ...
            >
              ...
              <div className="p-3">
                <h3 className="font-semibold text-ink-800 text-xs leading-snug line-clamp-2">
                  {book.title}
                </h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="table-header">
                  ...
                  <th className="px-6 py-3.5 text-left text-xs hidden xl:table-cell">
                    ID
                  </th>
                </tr>
              </thead>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-ink-400 text-xs md:hidden">
                            {book.author}
                          </p>
                        </div>
                      </div>
