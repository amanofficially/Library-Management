...
const Toast = ({ msg, type, onClose }) => (
  <div
    className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 rounded-2xl shadow-xl animate-slide-up text-sm font-medium
            ...
            <table className="w-full">
              <thead>
                <tr className="table-header">
                  ...
                  <th className="px-6 py-3.5 text-left text-xs hidden sm:table-cell">
                    Email
                  </th>
                  <th className="px-6 py-3.5 text-left text-xs hidden md:table-cell">
                    Course
                  </th>
                  <th className="px-6 py-3.5 text-left text-xs hidden lg:table-cell">
                    Age
                  </th>
                  <th className="px-6 py-3.5 text-left text-xs hidden lg:table-cell">
                    ID
                  </th>
                  <th className="px-6 py-3.5 text-center text-xs w-20">
                    Action
                  </th>
                </tr>
              </thead>
                ...
                {filtered.map((student, i) => (
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-9 h-9 rounded-full flex items-center justify-center text-white text-xs font-semibold shrink-0 ${avatarColor(student.name)}`}
                        >
                    ...
                    <td className="px-6 py-4 text-ink-500 text-sm hidden sm:table-cell">
                      {student.email}
                    </td>
                    <td className="px-6 py-4 text-ink-500 text-sm hidden md:table-cell">
                      {student.course || "—"}
                    </td>
                    <td className="px-6 py-4 text-ink-500 text-sm hidden lg:table-cell">
                      {student.age || "—"}
                    </td>
